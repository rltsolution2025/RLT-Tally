...
export class TallySaidapetComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.meta.updateTag({
      property: 'og:title',
      content: 'Tally Training Institute in Saidapet, Chennai  | Authorized Tally Partner',
    });
    ...
    this.meta.updateTag({
      ...
      content:
        'Learn TallyPrime, GST & accounting with practical training in Saidapet. We are an authorized tally partner.',
    });
    ...
    this.addJsonLd({
      ...
      description:
        'We are an Authorized Tally Partner. Tally training institute in Saidapet offering GST, accounting, and practical finance training.',
